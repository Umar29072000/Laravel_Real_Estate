                                ...
                                <div class="row">
                                    <div class="col-lg-6 mb-3">
                                        <input type="text" name="name"
                                            ...
                                            style="height: 45px" placeholder="Name" />
                                        @error('name')
                                    ...
                                    <div class="col-lg-6 mb-3">
                                        <input type="email" name="email"
                                            ...
                                            style="height: 45px" placeholder="Email" />
                                        @error('email')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="row">
                                    <div class="col-lg-6 mb-3">
                                        <input type="number" name="phone"
                                            ...
                                            style="height: 45px" placeholder="Mobile Phone" />
                                        @error('phone')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                    ...
                                    <div class="col-lg-6 mb-3">
                                        <input type="number" name="fax"
                                            ...
                                            style="height: 45px" placeholder="Fax" />
                                        @error('fax')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="row">
                                    <div class="col">
                                        <input type="number" name="whatsapp"
                                            ...
                                            style="height: 45px" placeholder="Whatsapp" />
                                        @error('whatsapp')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="row">
                                    <div class="col" style="text-align: initial">
                                        ...
                                        <input type="file" name="profile"
                                            ...
                                            style="height: 45px" placeholder="Profile" />
                                        @error('profile')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="row">
                                    <div class="col-lg-6 mb-3">
                                        <input type="password" name="password"
                                            ...
                                            style="height: 45px" placeholder="Password" />
                                        @error('password')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                    ...
                                    <div class="col-lg-6 mb-3">
                                        <input type="password" name="password_confirmation"
                                            class="form-control bg-white border-secondary" style="height: 45px"
                                            placeholder="Confirm Password" />
                                    </div>
                                </div>
                            </div>
                            <button type="submit" class="btn fw-bold fs-5 mx-auto btn-primary mt-3 py-3 px-5">
                                Register
                            </button>
