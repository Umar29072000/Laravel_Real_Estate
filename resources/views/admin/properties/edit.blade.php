        ...
        <div class="row mb-5">
                ...
                <div class="card shadow mb-2">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover datatable datatable-property" cellspacing="0"
                                width="100%">
                                <thead>
                                    <tr>
                                        <th>No</th>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn-group btn-group-sm">
                                                    <a href="{{ route('admin.properties.features.edit', [$property->id, $feature->id]) }}"
                                                        class="btn btn-info">
                                                        <i class="fa fa-pencil-alt"></i>
                                                    </a>
                                                    <form onclick="return confirm('are you sure ? ')" class="d-inline"
                                                        action="{{ route('admin.properties.features.destroy', [$property->id, $feature->id]) }}"
                                                        method="POST">
                                                        @csrf
                                                        @method('delete')
            ...
            <div class="col-lg-6">
                                ...
                                <tbody>
                                    @forelse($property->galleries as $gallery)
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn-group btn-group-sm">
                                                    <a href="{{ route('admin.properties.galleries.edit', [$property->id, $gallery->id]) }}"
                                                        class="btn btn-info">
                                                        <i class="fa fa-pencil-alt"></i>
                                                    </a>
                                                    <form onclick="return confirm('are you sure ? ')" class="d-inline"
                                                        action="{{ route('admin.properties.galleries.destroy', [$property->id, $gallery->id]) }}"
                                                        method="POST">
                                                        @csrf
                                                        @method('delete')
                                                        <button class="btn btn-danger"
                ...
                <div class="card shadow">
                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.properties.galleries.store', $property->id) }}" method="POST"
            ...
            <div class="card-body">
                <form action="{{ route('admin.properties.update', $property->id) }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <select name="category_id" class="form-control" id="category">
                            @foreach ($categories as $category)
                                <option {{ $category->id == $property->category->id ? 'selected' : null }}
                    ...
                    <div class="form-group">
                        <label for="name">{{ __('Name') }}</label>
                        <input type="text" class="form-control" id="name" placeholder="{{ __('Name') }}"
                            name="name" value="{{ old('name', $property->name) }}" />
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="location" placeholder="{{ __('location') }}"
                            name="location" value="{{ old('location', $property->location) }}" />
                    </div>
                    <div class="form-group">
                        <label for="bed">{{ __('Number of Bed') }}</label>
                        <input type="number" class="form-control" id="bed" placeholder="{{ __('bed') }}"
                            name="bed" value="{{ old('bed', $property->bed) }}" />
                    </div>
                    <div class="form-group">
                        <label for="bath">{{ __('Number of Bath') }}</label>
                        <input type="number" class="form-control" id="bath" placeholder="{{ __('bath') }}"
                            name="bath" value="{{ old('bath', $property->bath) }}" />
                    </div>
                    <div class="form-group">
                        <label for="size">{{ __('Number of Size') }}</label>
                        <input type="number" class="form-control" id="size" placeholder="{{ __('size') }}"
                            name="size" value="{{ old('size', $property->size) }}" />
                    </div>
                    <div class="form-group">
