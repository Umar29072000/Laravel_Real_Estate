            ...
            <div class="card-body">
                <form action="{{ route('admin.agents.update', $user->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" id="fax" placeholder="{{ __('fax') }}"
                            name="fax" value="{{ old('fax', $user->fax) }}" />
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" id="whatsapp" placeholder="{{ __('whatsapp') }}"
                            name="whatsapp" value="{{ old('whatsapp', $user->whatsapp) }}" />
                    </div>
                    <div class="form-group">
                        <img width="200" height="200" src="{{ Storage::url($user->profile) }}"
                            class="img-fluid rounded" alt="">
                    </div>
                    <div class="form-group">
                        <label for="profile">{{ __('profile') }}</label>
                        <input type="file" class="form-control" id="profile" placeholder="{{ __('profile') }}"
                            name="profile" value="{{ old('profile', $user->profile) }}" />
                    </div>
                    <div class="form-group">
