                    ...
                    <div class="card p-3 border-0">
                        ...
                        <form action="{{ route('contact.store') }}" method="post">
                            ...
                            <div class="form-group mb-3">
                                <div class="row">
                                    <div class="col">
                                        <input type="text" name="name" class="form-control bg-white border-secondary"
                                            style="height: 45px" placeholder="Name" value="{{ old('name') }}" />
                                    </div>
                                    <div class="col">
                                        <input type="email" name="email" class="form-control bg-white border-secondary"
                                            style="height: 45px" placeholder="Email" value="{{ old('email') }}" />
                                    </div>
                                </div>
                            </div>
                            <div class="form-group mb-3">
                                <div class="row">
                                    <div class="col">
                                        <input type="text" name="subject" class="form-control bg-white border-secondary"
                                            style="height: 45px" placeholder="Subject" value="{{ old('subject') }}" />
                                    </div>
                                </div>
                            </div>
                            <div class="form-group mb-3">
                                <div class="row">
                                    <div class="col">
                                        <textarea name="message" class="form-control bg-white border-secondary" rows="10" placeholder="Message">{{ old('message') }}</textarea>
                                    </div>
                                </div>
                            </div>
